...
class MockEncryptionKey:
    ...
    def __init__(self, key: str, id: str = None, notes: str = None, created_at: datetime = None):
...
class TestJWTService:
    ...
    def setup_method(self):
        ...
        self.keys = [
            MockEncryptionKey("test_key_1", "key1", "First test key", datetime(2023, 1, 1)),
            MockEncryptionKey("test_key_2", "key2", "Second test key", datetime(2023, 1, 2)),
        ]
    ...
    def test_jws_jwe_round_trip(self):
        ...
        assert jws_decoded['permissions'] == jwe_decoded['permissions'] == ['read', 'write']
    ...
    def test_token_expiration(self):
        ...
        assert abs(time_diff.total_seconds() - 900) < 5  # Within 5 seconds of 15 minutes
