...
class SQLAlchemyConversationCallbackContext(ConversationCallbackContext):
    ...
    async def search_conversation_callbacks(
        ...
        if conversation_id is not None:
            conditions.append(StoredConversationCallback.conversation_id == conversation_id)
    ...
    async def batch_get_conversation_callbacks(
        ...
        callback_map = {callback.id: callback.to_pydantic() for callback in stored_callbacks}
